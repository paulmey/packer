...
func (sigd SharedImageGalleryDestination) ResourceID() string {
	return fmt.Sprintf("/subscriptions/.../resourceGroups/%s/providers/Microsoft.Compute/galleries/%s/images/%s/versions/%s",
		sigd.ResourceGroup,
		sigd.GalleryName,
		sigd.ImageName,
		sigd.ImageVersion)
